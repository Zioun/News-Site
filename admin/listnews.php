    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>All News</h3>
                <p class="text-subtitle text-muted">All News Data Table</p>
            </div>
                ...
                <table class='table table-striped' id="table1">
                    ...
                    <tbody>
                        <?php
                            ...
                            $getNewsData = $news->getNewsDataAdmin();
                            
                            if($getNewsData){
                                while($getNews = $getNewsData->fetch_assoc()){     
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <span class="reporter_name"><?php echo $getNews['categoryName'];?></span>
                                </td>
                                <td>
