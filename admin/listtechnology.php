    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Technology News Data Table</p>
            </div>
                ...
                <table class='table table-striped' id="table1">
                    ...
                    <tbody>
                        <?php
                            ...
                            $getNewsTechnology = $news->getNewsTechnologyAdmin();
                            
                            if($getNewsTechnology){
                                while($getNews = $getNewsTechnology->fetch_assoc()){     
